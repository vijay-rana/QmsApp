//
//  InspectionDataViewController.m
//  QMS
//
//  Created by kbs on 3/16/16.
...
@interface InspectionDataViewController ()<MFMailComposeViewControllerDelegate>
{
...
@implementation InspectionDataViewController
 bool isShownMe = false; //for toggle of view
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        {
            //Use iPhone5 VC
            self = [super initWithNibName:@"InspectionDataViewController" bundle:nil];
        }
        else{
            //Use Default VC
            self = [super initWithNibName:@"InspectionDataViewController" bundle:nil];
...
-(void) showMenuSlider:(BOOL) show{
    ...
    if (isShownMe != show) {
        ...
        [overlayView setHidden:isShownMe];
    }
...
- (IBAction)btnPanelDownloadFormTemplate:(id)sender {
    ...
    [vcArray enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
        if ([obj isKindOfClass:[InspectionsViewController class]] == YES){
    ...
    if (isDataFormsExistInArray == YES) {
        ...
        InspectionsViewController *downloadFormTempView=[[InspectionsViewController alloc]initWithNibName:@"InspectionsViewController" bundle:nil];
