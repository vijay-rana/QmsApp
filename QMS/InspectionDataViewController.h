//
//  InspectionDataViewController.h
//  QMS
//
...
@interface InspectionDataViewController : UIViewController<UIScrollViewDelegate,UIDocumentInteractionControllerDelegate,UIAlertViewDelegate,UITableViewDataSource,UITableViewDelegate>
{
